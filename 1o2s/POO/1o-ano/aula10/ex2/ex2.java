...
public class ex2 {
    public static void main(String[] args) {
        ...
        Map <String, ArrayList <String>> ordenar = new HashMap();
        ...
        do{
            ...
            switch(input){
                ...
                case 2:
                    ...
                    ArrayList<String> significado1 = new ArrayList<String>(); //fazer os inputs dentro da array de modo a adicionar a array completa
